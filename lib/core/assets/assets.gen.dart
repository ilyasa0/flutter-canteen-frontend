...
class $AssetsLottieGen {
  ...
  /// File path: assets/lottie/apple.json
  LottieGenImage get apple => const LottieGenImage('assets/lottie/apple.json');
  LottieGenImage get carts => const LottieGenImage('assets/lottie/cart.json');


  /// List of all assets
  List<LottieGenImage> get values => [apple];
  List<LottieGenImage> get values2 => [carts];
}
