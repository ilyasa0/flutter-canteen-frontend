      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            // child: Assets.lottie.carts.lottie(width: 200, height: 200),

            child: Image.asset(Assets.images.logo.path, width: 100, height: 100,),
          ),
          ...
          const Center(
            child: Text(
              'All you need is a lots of delicious food for you ',
